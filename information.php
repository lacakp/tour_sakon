...
<div class="container mt-4 mb-4 p-3 d-flex justify-content-center">
    <div class="card p-4">
        <h1> <br><div 
                ...
                <br><div class="d-flex flex-row justify-content-center align-items-center gap-2"> <span class="idd1"> วันที่และเวลา: <?php echo $row['date'] ?></span> <span><i class="fa fa-copy"></i></span> </div>
                <br>
                ...
                <div class="d-flex flex-row justify-content-center align-items-center mt-3"> <span class="number">รายละเอียด<span class="follow"> <p><br><?php echo $row['detail'] ?></p></span></span> </div>

                <br><a href="#?id=<?php echo $id ?>" class="btn btn-warning">
                    <h1>สั่งซื้อทัวร์</h1>
                </a>
